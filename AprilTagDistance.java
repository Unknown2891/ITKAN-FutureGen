...
public class AprilTagTest extends LinearOpMode {
    ...
    // AprilTag physical dimensions (in inches)
    private static final double TAG_SIZE = 2.0; // Size of the tag in inches
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            // Loop through all detections and display info
    ...
    private void displayTagInfo(AprilTagDetection detection) {
        ...
        // Calculate and display additional distance information
