...
public class Limelight extends OpMode {
    ...
    public void loop() {
      ...
      //  limelight.updateRobotOrientation(orientation.getYaw(AngleUnit.DEGREES));
        ...
        double turn = gamepad1.right_stick_x;  
            ...
            if(gamepad1.right_bumper || gamepad2.right_bumper || gamepad1.right_trigger > 0.05){
                intake.setPower(1);
                transfer.setPower(1);
                gate.setPosition(closed);
            }
            else if(gamepad1.left_bumper || gamepad2.left_bumper || gamepad1.left_trigger > 0.05){
                intake.setPower(-1);
                transfer.setPower(-1);                                      
            }else{
                intake.setPower(0);
        ...
        if (gamepad1.a) {
            ...
            telemetry.addData("outtakeL Velocity", outtakeL.getVelocity());
    ...
    private double calculatePID(double tx) {
        ...
        double output = proportional - feedForward+minPow;
        return -output;
    }
